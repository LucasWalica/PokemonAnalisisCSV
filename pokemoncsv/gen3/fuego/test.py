...
with open('pokemoncsv/gen3/fuego/fuego3thGen.csv', 'r', encoding='UTF-8') as csv_file:
...
datos = pd.read_csv('pokemoncsv/gen3/fuego/fuego3thGen.csv')
print(datos)
...
plt.xlabel('Pokemon')
plt.ylabel('Values')
plt.title('3th generation Fire Pokemons')
plt.tight_layout()
