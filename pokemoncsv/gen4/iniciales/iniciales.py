...
with open('pokemoncsv\cuarta_gen\iniciales\Iniciales.csv', 'r', encoding='UTF-8') as csv_file:
...
datos = pd.read_csv('pokemoncsv\cuarta_gen\iniciales\Iniciales.csv')
print(datos)
...
plt.xlabel('Pokemon')
plt.ylabel('Values')
plt.title('Starters 4th Gen Pokemon')
plt.tight_layout()
