...
with open('pokemoncsv/gen2/gen_two_pokemon.csv', 'r', encoding='UTF-8') as csv_file:
...
datos = pd.read_csv('pokemoncsv/gen2/gen_two_pokemon.csv')
print(datos)
